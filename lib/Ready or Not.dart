...
class ReadyorNot extends StatefulWidget {
  @override
  _ReadyorNot createState() => _ReadyorNot();
}

class _ReadyorNot extends State<ReadyorNot> {
    ...
    return Scaffold(
        body: FutureBuilder(
            ...
            builder: (context, AsyncSnapshot snapshot) {
              Details details = snapshot.data[7];
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      FutureBuilder(
                          ...
                          builder: (context, AsyncSnapshot snapshot) {
                            MovieHome similar1 = snapshot.data[5];
                            MovieHome similar2 = snapshot.data[6];
