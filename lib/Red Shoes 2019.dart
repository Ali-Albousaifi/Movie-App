...
class RedShoes2019 extends StatefulWidget {
  @override
  _RedShoes2019 createState() => _RedShoes2019();
}

class _RedShoes2019 extends State<RedShoes2019> {
    ...
    return Scaffold(
        body: FutureBuilder(
            ...
            builder: (context, AsyncSnapshot snapshot) {
              Details details = snapshot.data[10];
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      FutureBuilder(
                          ...
                          builder: (context, AsyncSnapshot snapshot) {
                            MovieHome similar1 = snapshot.data[8];
                            MovieHome similar2 = snapshot.data[9];
