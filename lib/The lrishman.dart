...
class TheLirshman extends StatefulWidget {
  @override
  _TheLirshman createState() => _TheLirshman();
}

class _TheLirshman extends State<TheLirshman> {
    ...
    return Scaffold(
        body: FutureBuilder(
            ...
            builder: (context, AsyncSnapshot snapshot) {
              Details details = snapshot.data[2];
