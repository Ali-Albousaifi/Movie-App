...
class KnivesOut extends StatefulWidget {
  @override
  _KnivesOut createState() => _KnivesOut();
}

class _KnivesOut extends State<KnivesOut> {
    ...
    return Scaffold(
        body: FutureBuilder(
            ...
            builder: (context, AsyncSnapshot snapshot) {
              Details details = snapshot.data[5];
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      FutureBuilder(
                          ...
                          builder: (context, AsyncSnapshot snapshot) {
                            MovieHome similar1 = snapshot.data[3];
                            MovieHome similar2 = snapshot.data[4];
