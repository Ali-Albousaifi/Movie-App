...
class ItChapterTwo extends StatefulWidget {
  @override
  _ItChapterTwo createState() => _ItChapterTwo();
}

class _ItChapterTwo extends State<ItChapterTwo> {
    ...
    return Scaffold(
        body: FutureBuilder(
            ...
            builder: (context, AsyncSnapshot snapshot) {
              Details details = snapshot.data[6];
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      FutureBuilder(
                          ...
                          builder: (context, AsyncSnapshot snapshot) {
                            MovieHome similar1 = snapshot.data[4];
                            MovieHome similar2 = snapshot.data[5];
