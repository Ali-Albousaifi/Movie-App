...
class OnePieceStampede extends StatefulWidget {
  @override
  _OnePieceStampede createState() => _OnePieceStampede();
}

class _OnePieceStampede extends State<OnePieceStampede> {
    ...
    return Scaffold(
        body: FutureBuilder(
            ...
            builder: (context, AsyncSnapshot snapshot) {
              Details details = snapshot.data[8];
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      FutureBuilder(
                          ...
                          builder: (context, AsyncSnapshot snapshot) {
                            MovieHome similar1 = snapshot.data[6];
                            MovieHome similar2 = snapshot.data[7];
