...
class AngelHasFallen extends StatefulWidget {
  @override
  _AngelHasFallen createState() => _AngelHasFallen();
}

class _AngelHasFallen extends State<AngelHasFallen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        body: FutureBuilder(
          ...
          {
              Details details=snapshot.data[4];
            ...
            children: <Widget>[
              ...
              FutureBuilder(
                ...
                {   MovieHome similar1=snapshot.data[2];
                    MovieHome similar2=snapshot.data[3];
